...
public class PasswordValidator {
    ...
    public Set<String> validate(String password) {
        ...
        if(failures.size()==0){
        	failures.add("The Password Validation is correct");
        }
        return failures;
    }

    public void checkSequenceRepetition(String password, Set<String> failures) {
    ...
    public void checkLetterAndDigit(String password, Set<String> failures) {
    ...
    public void checkCase(String password, Set<String> failures) {
    ...
    public void checkLength(String string, Set<String> failures) {
